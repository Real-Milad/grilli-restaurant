  ...
  return (
    <section className="w-full py-25 px-6 flex-center flex-col gap-9 relative">
      ...
      <div className="lg:grid lg:grid-cols-2 lg:gap-x-40">
        ...
        {menu.map(item => 
          <div key={item.id} className="flex gap-5 mb-10 md:mt-10 lg:pr-25 lg:mt-20 ">
            ...
            <div className="flex-2 relative">
              ...
              <p className="text-neutral-400 leading-8 text-[15px] md:text-[17px] md:pr-20 lg:mt-10">{item.info}</p>
            </div>
